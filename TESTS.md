...
- **Only a credential the ACCOUNT accepted may lower `needsLogin`.** A started
  ...
  verified device login) each have their own test. The same rule has a second
