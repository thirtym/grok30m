...
const header = `# Grok30m

[![License: FSL-1.1-MIT](https://img.shields.io/badge/License-FSL--1.1--MIT-blue.svg)](https://github.com/thirtym/grok30m/blob/main/LICENSE) ![Agents](https://img.shields.io/badge/Agents-Grok%20Build%20%C2%B7%20Codex%20%C2%B7%20Claude%20Code-000000) [![VS Code](https://img.shields.io/badge/VS%20Code-Extension-007ACC?logo=visualstudiocode&logoColor=white)](https://code.visualstudio.com) [![Cursor](https://badgen.net/badge/Cursor/Extension/007ACC)](https://cursor.com)

> **30m fork of Grok Build for VS Code (Community)** — [thirtym/grok30m](https://github.com/thirtym/grok30m). Not affiliated with or endorsed by SpaceXAI (formerly xAI) or Paweł Huryn. *Grok*, *Grok Build*, and *xAI* are trademarks of xAI; this project uses those names only to describe what it's compatible with.
...
**1. Install the extension.** Download the VSIX from [thirtym/grok30m releases](https://github.com/thirtym/grok30m/releases) and run \`cursor --install-extension grok30m-*.vsix\` (or \`code --install-extension\`).
...
Grok opens in the **Secondary Side Bar** (right side, next to other AI tools). Cursor 3.15 refuses that dock — the extension moves chat to the left activity bar on a first install and on an upgrade from 1.5.7. Prefer it elsewhere? Gear → **Config & debug** → **Move view**, or **Grok: Move Chat View**.

> Prefer the terminal, building from source, or installing into several IDEs at once? See the project [INSTALL docs](https://github.com/thirtym/grok30m/blob/grok30m/docs/INSTALL.md).
