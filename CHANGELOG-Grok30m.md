...
- **Merge community 4.12.1** (auto-sync).
...
- **Merge community 4.11.0** (auto-sync).
- **Grok30m UX kept:** editor-tab chat, Sessions sidebar, hide automated sessions.

## 2.1.8

- **Merge community 4.10.0** (auto-sync).
- **Grok30m UX kept:** editor-tab chat, Sessions sidebar, hide automated sessions.

## 2.1.7

- **Merge community 4.9.0** (auto-sync).
- **Grok30m UX kept:** editor-tab chat, Sessions sidebar, hide automated sessions.

## 2.1.6

- **Merge community 4.8.0** (auto-sync).
- **Grok30m UX kept:** editor-tab chat, Sessions sidebar, hide automated sessions.
...
- **Merge community 4.6.1** (auto-sync).
- **Grok30m UX kept:** editor-tab chat, Sessions sidebar, hide automated sessions.
