...
**Grok30m** is the [30m fork](https://github.com/thirtym/grok30m) of [Grok Build for VS Code (Community)](https://github.com/phuryn/grok-build-vscode). Same client, 30m-maintained. Extension id `grok30m.grok30m`.

> Not affiliated with or endorsed by SpaceXAI (formerly xAI) or Paweł Huryn. *Grok*, *Grok Build*, and *xAI* are trademarks of xAI.

Install from a [release VSIX](https://github.com/thirtym/grok30m/releases): `cursor --install-extension grok30m-2.0.1.vsix`
